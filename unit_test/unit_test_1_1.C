
{
   ...
   TFile f1("unit_test_1_1.root");
   TH1D* h1 = (TH1D*) f1.Get("5");
   h1->SetTitle("Angular distribution of 15.7 MeV e- after 9um Au foil, Hanson et al. Phys.Rev.84p.634(1951)");
   h1->Scale(0.0440 / h1->GetMaximum());
